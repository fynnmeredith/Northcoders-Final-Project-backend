...
exports.getGoalsByUser = exports.patchGoalProgress = exports.patchGoalStatus = exports.patchGoalDetails = exports.getGoalByGoalId = exports.deleteGoal = exports.postGoal = void 0;
...
var postGoal = function (req, res, next) {
    ...
    if (!objective || !start_date || !end_date || !owner) {
        ...
        return (0, checkExists_1.checkUserExists)(owner)
            ...
            return (0, goals_model_1.insertGoal)(objective, description, start_date, end_date, owner, target_value, unit);
        })
            .then(function (goal) {
...
var deleteGoal = function (req, res, next) {
    ...
    if (!Number.isInteger(parseInt(goal_id))) {
        ...
        return (0, checkExists_1.checkGoalExists)(goal_id)
            ...
            return (0, goals_model_1.deleteGoalFrom)(goal_id);
        })
            .then(function () {
            res.status(204).send();
        })["catch"](next);
...
var patchGoalStatus = function (req, res, next) {
    ...
    if (!Number.isInteger(parseInt(goal_id))) {
        ...
        return (0, checkExists_1.checkGoalExists)(goal_id)
            ...
            return (0, goals_model_1.updateGoalStatus)(goal_id, status, date);
        })
            .then(function (goal) {
            res.status(200).send({ goal: goal });
        })["catch"](next);
...
var patchGoalProgress = function (req, res, next) {
    ...
    if (!date || !value) {
        ...
        return (0, goals_model_1.selectGoalByGoalId)(goal_id)
            ...
            return (0, goals_model_1.updateGoalProgress)(goal_id, date, value, goal.progress, goal.target_value);
        })
            .then(function (goal) {
            res.status(200).send({ goal: goal });
        })["catch"](next);
    ...
    if (from_date && !/\d{4}-\d{2}-\d{2}/.test(from_date)) {
        ...
        if (formattedToDate_1 &&
            ...
            return (0, checkExists_1.checkUserExists)(username)
                ...
                return (0, goals_model_1.selectGoalsByUser)(username, formattedFromDate_1, formattedToDate_1);
            })
                .then(function (goals) {
