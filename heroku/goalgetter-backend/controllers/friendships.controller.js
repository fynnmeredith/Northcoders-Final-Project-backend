...
var postFriendship = function (req, res, next) {
    ...
    if (!user_1 || !user_2) {
        ...
        return checkExists_1.checkUserExists(user_1)
            ...
            return friendships_model_1.insertFriendship(user_1, user_2);
        })
...
var deleteFriendship = function (req, res, next) {
    ...
    if (!Number.isInteger(parseInt(friendship_id))) {
        ...
        return checkExists_1.checkFriendshipExists(friendship_id)
            ...
            return friendships_model_1.deleteFriendshipFrom(friendship_id);
        })
            .then(function () {
            res.status(204).send();
        })["catch"](next);
...
var getFriendshipsbyUser = function (req, res, next) {
    ...
    return checkExists_1.checkUserExists(username)
        ...
        return friendships_model_1.selectFriendshipsByUser(username);
    })
