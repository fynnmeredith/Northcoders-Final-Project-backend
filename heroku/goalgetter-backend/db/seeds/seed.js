...
var seed = function (data) {
    ...
    return connection_1.db
        ...
        .then(function () {
        var query = pg_format_1["default"]("INSERT INTO users\n          (username, profile, avatar_url)\n          VALUES\n          %L;", format_1.formatUsers(userData));
        return connection_1.db.query(query);
    })
        .then(function () {
        var query = pg_format_1["default"]("INSERT INTO goals\n          (objective, description, start_date, end_date, type, status, owner, target_value, unit, progress, finish_date)\n          VALUES\n          %L;", format_1.formatGoals(goalData));
        return connection_1.db.query(query);
    })
        .then(function () {
        var query = pg_format_1["default"]("INSERT INTO subgoals\n          (goal_id, objective, start_date, end_date, type, status, owner, target_value, unit, progress, finish_date)\n          VALUES\n          %L;", format_1.formatSubgoals(subgoalData));
        return connection_1.db.query(query);
    })
        .then(function () {
        var query = pg_format_1["default"]("INSERT INTO posts\n          (associated_data_type, associated_id, owner, datetime, message)\n          VALUES\n          %L;", format_1.formatPosts(postData));
        return connection_1.db.query(query);
    })
        .then(function () {
        var query = pg_format_1["default"]("INSERT INTO comments\n          (post_id, owner, message, datetime)\n          VALUES\n          %L;", format_1.formatComments(commentData));
        return connection_1.db.query(query);
    })
        .then(function () {
        var query = pg_format_1["default"]("INSERT INTO reactions\n          (post_id, owner, reaction)\n          VALUES\n          %L;", format_1.formatReactions(reactionData));
        return connection_1.db.query(query);
    })
        .then(function () {
        var query = pg_format_1["default"]("INSERT INTO friendships\n          (user_1, user_2)\n          VALUES\n          %L;", format_1.formatFriendships(friendshipData));
        return connection_1.db.query(query);
    });
};
exports.seed = seed;
