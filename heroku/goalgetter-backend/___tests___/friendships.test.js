...
describe("/api/friendships/:friendship_id", function () {
    describe("DELETE", function () {
        test("successfully deletes friends if friendship_id is valid", function () {
            return supertest_1["default"](app_1.app)["delete"]("/api/friendships/4")
                .expect(204)
                .then(function () {
                return checkExists_1.checkFriendshipExists(4);
            })
        ...
        test("returns error if friendship_id is invalid", function () {
            return supertest_1["default"](app_1.app)["delete"]("/api/friendships/four")
                .expect(400)
                .then(function (res) {
                expect(res.body.message).toBe("Bad request");
            });
        ...
        test("returns error if friendship does not exist", function () {
            return supertest_1["default"](app_1.app)["delete"]("/api/friendships/9999")
                .expect(404)
                .then(function (res) {
