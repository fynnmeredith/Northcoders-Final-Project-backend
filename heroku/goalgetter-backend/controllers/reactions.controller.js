...
var postReaction = function (req, res, next) {
    ...
    if (!owner || !reaction) {
        ...
        return checkExists_1.checkPostExists(post_id)
            ...
            return checkExists_1.checkIfUserHasReacted(post_id, owner);
        })
            ...
            return reactions_model_1.insertReaction(post_id, owner, reaction);
        })
...
var deleteReaction = function (req, res, next) {
    ...
    if (!Number.isInteger(parseInt(reaction_id))) {
        ...
        return checkExists_1.checkReactionExists(reaction_id)
            ...
            return reactions_model_1.deleteReactionFrom(reaction_id);
        })
            .then(function () {
            res.status(204).send();
        })["catch"](next);
...
var getReactionsByPost = function (req, res, next) {
    ...
    if (!Number.isInteger(parseInt(post_id))) {
        ...
        return checkExists_1.checkPostExists(post_id)
            ...
            return reactions_model_1.selectReactionsByPost(post_id);
        })
